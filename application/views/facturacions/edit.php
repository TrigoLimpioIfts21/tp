...
<div id="edit_sale_wrapper">
	<h1><?php echo $this->lang->line('sales_edit_sale'); ?> PEDIDO <?php echo $sale_info['sale_id']; ?></h1>
	
	<?php echo form_open("facturacions/save/".$sale_info['sale_id'],array('id'=>'sales_edit_form')); ?>
	<ul id="error_message_box"></ul>
	
	<div class="field_row clearfix">
	<?php echo form_label($this->lang->line('sales_receipt').':', 'customer'); ?>
		<div class='form_field'>
			<?php echo anchor('facturacions/receipt/'.$sale_info['sale_id'], 'PEDIDO '.$sale_info['sale_id'], array('target' => '_blank'));?>
		</div>
	</div>
	...
	<?php echo form_open("facturacions/delete/".$sale_info['sale_id'],array('id'=>'sales_delete_form')); ?>
		<?php
		echo form_submit(array(
			'name'=>'submit',
			'id'=>'submit',
